  ...
  return (
    <section className="relative py-24 sm:py-32 overflow-hidden bg-slate-950 text-white">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <img
          src={ctaImage}
          alt="GlobeTrotter Cinematic Travel Landscape"
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-8">
        ...
        <FadeIn delay={0.2}>
          <p className="text-base sm:text-xl text-slate-300 max-w-xl mx-auto leading-relaxed">
            Your next adventure is closer than you think. Build your multi-city route and daily schedule in minutes.
          </p>
        </FadeIn>
        ...
        <FadeIn delay={0.3}>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            <Link
              href="/trips/new"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-4 rounded-2xl bg-[#F95724] hover:bg-[#EA580C] text-white font-bold text-sm sm:text-base shadow-xl shadow-orange-600/30 transition-all hover:scale-105 active:scale-98"
            >
            ...
            <Link
              href="/explore"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-4 rounded-2xl bg-white/10 hover:bg-white/20 text-white font-semibold text-sm sm:text-base border border-white/15 backdrop-blur-md transition-all"
            >
              <MapPin className="w-4 h-4 text-slate-300" /> Explore Destinations
            </Link>
          </div>
        </FadeIn>
      </div>
