...
const AppContent: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-between selection:bg-rose-500 selection:text-white relative bg-[#FAFAFA] dark:bg-[#0B0F17] transition-colors duration-200">
      {/* Top Navigation */}
      <Navbar
        onOpenCreateTrip={() => setIsCreateTripOpen(true)}
        onOpenOnboarding={() => setIsOnboardingOpen(true)}
      ...
      <div className="fixed bottom-6 right-6 z-40">
        ...
        >
          <div className="relative w-10 h-10 rounded-full overflow-hidden border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 animate-globi-soft flex-shrink-0">
          ...
          <div className="text-left hidden sm:block">
            ...
            <p className="text-[10px] text-slate-500 dark:text-slate-400 font-medium">AI Companion</p>
          </div>
